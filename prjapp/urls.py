...
urlpatterns = [
    ...
    path('Amazon_uk/' , views.Amazon_uk , name='Amazon_uk'),
    path('Amazon_german/' , views.Amazon_german , name='Amazon_german'),
    path('Razer_Gold/' , views.Razer_Gold , name='Razer_Gold'),
    path('Razer_Gold_Global/' , views.Razer_Gold_Global , name='Razer_Gold_Global'),
    path('Uber/' , views.Uber , name='Uber'),
    path('Master_Card/' , views.Master_Card , name='Master_Card'),
    path('Itunes/' , views.Itunes , name='Itunes'),
    path('FreeFire&Pubg/' , views.FreeFirePubg , name='FreeFire&Pubg'),
    ...
    path('verifed_coupon/', views.verifed_coupon , name= 'verifed_coupon'),
    ...
    path('get_transaction_info/' , views.get_transaction_info , name='get_transaction_info')
